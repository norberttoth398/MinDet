...
classes = ('Plagioclase', )
data_root = '/kaggle/input/train-jpg/Train_jpg'
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        classes=('Plagioclase', ),
        ann_file='/kaggle/input/april22-large-training-set/train.json',
        img_prefix='/kaggle/input/april22-large-training-set/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='LoadAnnotations',
    ...
    val=dict(
        type='CocoDataset',
        classes=('Plagioclase', ),
        ann_file='/kaggle/input/april22-large-training-set/val.json',
        img_prefix='/kaggle/input/april22-large-training-set/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
    ...
    test=dict(type='CocoDataset',
        ...
        pipeline=[
            ...
            dict(
                type='MultiScaleFlipAug',
                img_scale=(2000, 1500),#used during inference
                flip=False,
                transforms=[
                    dict(type='Resize', keep_ratio=True),
                    dict(type='RandomFlip'),
